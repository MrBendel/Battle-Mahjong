...
fits the authored Board at an Inspector-tunable `1.00` of its maximum region
...
tiles render at `0.80` of the Board tile footprint. Portrait lays the slots out
