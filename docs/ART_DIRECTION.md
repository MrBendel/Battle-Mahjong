...
- The default gameplay background uses borderless near-black blue-charcoal surfaces with hand-drawn skull, star, cat, and tile motifs in restrained oxblood, dusty-cyan, violet, and ochre ink at the perimeter. Dedicated `941 x 1672` portrait and `1672 x 941` landscape compositions keep their gameplay regions quiet; trays and HUD components provide the structural frames.
