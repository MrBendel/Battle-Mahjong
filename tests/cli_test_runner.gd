...
func _run_tile_skin_contract_tests() -> void:
	...
	_check_equal(Vector2i(512, 736), Vector2i(skin.geometry.source_size[0], skin.geometry.source_size[1]), "skin records canonical source geometry")
	_check_equal(Vector2i(32, 46), Vector2i(skin.geometry.minimum_runtime_size[0], skin.geometry.minimum_runtime_size[1]), "skin records minimum runtime footprint")
