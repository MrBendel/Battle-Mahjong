...
- The Town Hub currently exposes Quick Play and Tower. Quick Play opens the seeded on-device layout picker; Tower creates an in-memory deterministic run and advances ordinary replayable game definitions floor by floor. Tower persistence, rewards, and checkpoints remain deferred.
