...
- The Default skin uses one shared `4:5` warm-ivory ceramic base in portrait and landscape. The board, tray, face-down composition, and animation previews share its geometry; orientation only reflows peripheral UI and never changes stable layout slots or simulation rules.
