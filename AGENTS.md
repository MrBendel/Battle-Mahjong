...
- The Default skin also has supplied portrait and derived landscape tile-back textures. Face-down tiles render those backs and use a two-phase horizontal flip with an edge-on art swap and brief additive afterimage; revealed tiles return to the normal base-plus-face composition.
