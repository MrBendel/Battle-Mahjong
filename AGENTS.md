...
- Portrait tray tiles center on each queue repeat's logical slot center. Layout may reclaim transparent source padding below the visible queue and bottom action dock, but live tile and consumable touch targets must remain inside the safe display.
