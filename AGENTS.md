...
- The responsive gameplay shell uses a portrait bottom action dock and a horizontal-reference landscape composition: status at upper-left, actions at lower-left, the broad Board in the center, and the shared porcelain tray rotated into the right rail. Decorative Character/FX and debug regions yield before gameplay space.
