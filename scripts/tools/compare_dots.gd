...
func _init() -> void:
	var ref_path := "C:/Users/andre/.gemini/antigravity-ide/brain/35005bd2-3004-434f-8564-00eb2b6c70fb/.user_uploaded/media_1788828848231.png"
	...
	# Target comparison size: height 500
	var h: int = 500
	...
	var out_w: int = ref_w + comp_w + 30
	var out := Image.create(out_w, h + 60, false, Image.FORMAT_RGBA8)
	out.fill(Color("#1a1a24"))

	out.blit_rect(ref_img, Rect2i(Vector2i.ZERO, ref_img.get_size()), Vector2i(10, 45))
	out.blit_rect(composite, Rect2i(Vector2i.ZERO, composite.get_size()), Vector2i(ref_w + 20, 45))
