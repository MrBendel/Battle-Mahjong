...
@export_file("*.png", "*.svg", "*.webp") var momentum_frame_path := "res://game-assets/ui/portrait/momentum_frame.png"
@export_file("*.png", "*.svg", "*.webp") var momentum_fill_path := "res://game-assets/ui/portrait/momentum_fill.png"
@export_file("*.png", "*.svg", "*.webp") var momentum_badge_path := "res://game-assets/ui/portrait/momentum_badge.png"
...
@export_file("*.png", "*.svg", "*.webp") var pause_button_path := "res://game-assets/ui/portrait/pause_button.png"
